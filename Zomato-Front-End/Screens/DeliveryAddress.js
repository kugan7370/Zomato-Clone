...
export default function DeliveryAddress() {
  ...
  const userAddress = async (values) => {
    ...
    const { paymentIntent, ephemeralKey, customer, publishableKey } =
      await addPayment({ amount: totalPrice });
          ...
          {({
            ...
            <View className="h-[95%] bg-white">
              <ScrollView showsVerticalScrollIndicator={false}>
                <View className="my-2">
                  <Text className="font-poppinsSemiBold text-gray-400 text-base">
                    Contact Details
                  </Text>
                </View>
                {/* fullname */}
                ...
                <View className="my-2">
                  <Text className="font-poppinsSemiBold text-gray-400 my-2 text-base">
                    Address
                  </Text>
                </View>
                {getLocation ? (
                  ...
                  <TouchableOpacity
                    onPress={chooseMap}
                    className="w-full  rounded-xl overflow-hidden border border-[1] border-gray-200 mb-4"
                  >
                    <Image
                    ...
                    <View className="my-2  p-4 rounded-lg justify-center items-center ">
                      <View className="flex-row items-center">
                        ...
                        <Text className=" tracking-wide font-poppins text-gray-400 text-base ml-4">
                ...
                <View className="my-2">
                  ...
                  />
                  {errors.city && (
                    <Text className="text-red-500">{errors.city}</Text>
                  )}
                </View>
              ...
              <TouchableOpacity
                ...
                className="bg-[#e53b3b] p-2 rounded-lg mt-4 "
              >
                <Text className="text-white text-center font-poppinsSemiBold p-1  text-base">
                  Proceed to pay
                </Text>
              </TouchableOpacity>
            </View>
