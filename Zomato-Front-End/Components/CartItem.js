...
export default function CartItem({ cartItem }) {
    ...
    return (
        <View className="flex-row items-center  mb-4 bg-slate-50 pr-4 rounded-lg">
            ...
            <View className="ml-6" >
                <Text className="font-bold mb-4 text-center font-poppins capitalize">{cartItem.name}</Text>
                <View className="flex-row justify-between items-center w-32  py-2 px-4 rounded-2xl">
                    ...
                    <Text className="font-bold font-poppins">  {cartItem.price} x {cartItem.quantity}  </Text>
            ...
            <Text className="font-bold ml-auto font-poppins">$ {cartItem.price * cartItem.quantity}</Text>
